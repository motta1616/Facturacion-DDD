package co.com.aquiles.facturacion.infra.config;

import co.com.aquiles.facturacion.infra.repo.MongoEventStoreRepository;
...
public class CommandConfiguration {
    private static final String PACKAGE_USE_CASE = "co.com.aquiles.facturacion.usecase.factura";
